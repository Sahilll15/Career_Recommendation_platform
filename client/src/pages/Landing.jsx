      ...
      <div className="bg-white dark:bg-gray-900">
              ...
              <div className="flex flex-wrap items-center justify-between gap-6 md:py-3 md:gap-0 lg:py-5">
                <div className="w-full items-center flex justify-between lg:w-auto">
                  <a className="relative z-10" href="#" aria-label="logo">
                    <h1 className="text-white text-xl">CAREER COMPASS</h1>
                  </a>
                  <label
                    htmlFor="hbr"
        ...
        <div className="bg-white relative pt-40 pb-20 lg:pt-44 dark:bg-gray-900">
          <div className="relative xl:container m-auto px-6 md:px-12 lg:px-6">
            ...
            Discover Your True North              <br className="lg:block hidden" />{" "}
            ...
            <div className="lg:flex">
              <div className="relative mt-8 md:mt-16 space-y-8 sm:w-10/12 md:w-2/3 lg:ml-0 sm:mx-auto text-center lg:text-left lg:mr-auto lg:w-7/12">
                ...
                Are you feeling lost in the vast landscape of career choices? Are you uncertain about the path that best suits your skills and aspirations? Look no further! Career Compass is here to guide you towards a fulfilling and successful professional journey.
            ...
            <div class="container px-5 py-24 mx-auto">
              <div class="p-5 bg-white flex items-center mx-auto   mb-10 border-gray-200 rounded-lg sm:flex-row flex-col">
                ...
                <div class="flex-grow sm:text-left text-center mt-6 sm:mt-0">
                  ...
                  At Career Compass, we understand that choosing the right career can be a <br/> daunting task. That's why we've developed a comprehensive Career Interest <br/>Assessment that leverages cutting-edge technology and psychometric tools to <br/>analyze your strengths, interests, and values. Our goal is to provide you with <br/>personalized recommendations tailored to your unique profile.                  </p>
